...
//            String path = absolutePath+"/src/main/resources/static/images/structures/"+code+".png" ;
//            try {
    ...
    public void structureImageInsert(String code, MultipartFile file) {
        if (!file.isEmpty()) {
            try {
                ...
                String path = "/app/static/images/structures/" + code + ".png";
...
//        String absolutePath = new File("").getAbsolutePath();
//        File file =  new File(absolutePath+"/src/main/resources/static/images/structures/"+code+".png");
//        try {
...
//    }
    ...
    public  StructureResponse.StructureFindAllDTO structureFindAllOrderName(String structureType) {
        ...
        if (structureType.equals("building")){
